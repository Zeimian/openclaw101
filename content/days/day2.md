...
2. 安装 Node.js v22：`curl -fsSL https://deb.nodesource.com/setup_22.x | sudo -E bash -`
3. 切换 npm 镜像：`npm config set registry https://registry.npmmirror.com`
4. 运行安装脚本：`curl -fsSL https://openclaw.ai/install.sh | bash`
