...
```bash
# 克隆仓库
git clone https://github.com/Zeimian/openclaw101.git
cd openclaw101
...
- 🐛 报告 Bug — [创建 Issue](https://github.com/Zeimian/openclaw101/issues)
- 💡 功能建议 — [创建 Issue](https://github.com/Zeimian/openclaw101/issues)
- 🌐 改进翻译 — 欢迎 PR
- 📝 改进内容 — 欢迎 PR
